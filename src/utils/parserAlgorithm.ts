...
import { expandAbbreviationsInText, DEFAULT_ABBREVIATIONS, NORMALIZED_ABBREVIATIONS_MAP, buildNormalizedAbbreviationsMapWithReplacements } from '../data/abbreviations';
